        ...
        {stage === 'stage1' && (
          ...
          >
            ...
            >
              ...
              >
                {/* Particle effects around this line */}
                {[...Array(20)].map((_, i) => {
          ...
          >
            ...
            >
              ...
              <motion.p
                ...
                className="text-base sm:text-xl md:text-2xl lg:text-4xl xl:text-5xl text-white font-bold max-w-5xl mx-auto px-6 py-3 sm:px-8 sm:py-4 bg-black/30 backdrop-blur-sm rounded-xl"
                style={{ textShadow: '0 4px 40px rgba(0,0,0,0.9), 0 2px 20px rgba(0,0,0,0.8), 0 0 80px rgba(168, 85, 247, 0.4)' }}
              >
