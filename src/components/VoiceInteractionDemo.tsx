                    ...
                    {state === 'listening' && (
                      ...
                      >
                        <motion.div className="relative w-32 h-32">
                          {/* Pulsing glow layers */}
                          <motion.div
                            className="absolute inset-0 rounded-full bg-gradient-to-br from-primary via-accent to-primary blur-2xl"
                            animate={{
                              scale: [1, 1.3, 1],
                              opacity: [0.6, 0.9, 0.6],
                              rotate: [0, 180, 360]
                          ...
                          {/* Main orb */}
                          <motion.div
                            className="absolute inset-4 rounded-full bg-gradient-to-br from-primary to-accent shadow-2xl flex items-center justify-center"
                            animate={{
                              scale: [1, 1.05, 1],
                            }}
                            transition={{
                          ...
                          >
                            <Radio className="w-14 h-14 text-white" strokeWidth={1.5} />
                          </motion.div>
                      ...
                      >
                        {displayResults.map((result, index) => (
                          ...
                          >
                            ...
                            <p className="text-base text-foreground leading-relaxed">{result}</p>
                          </motion.div>
                        ))}
                      </motion.div>
                    )}
